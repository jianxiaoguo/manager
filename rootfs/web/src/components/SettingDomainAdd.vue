...
<!--                    </div>-->
                                ...
                                <div class="ember-view">
                                    <div class="collaborator-edit">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <label class="f5 b gray mb2">Domain name</label>
                                                    <div class="cp-validating-gravatar-input form-group ember-view">
                                                        <div class="flex flex-auto">
                                                            <input :disabled="editAccess" placeholder="yourdomain.com" class="form-control hk-input   ember-text-field ember-view" required type="text" v-model="domain">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="hk-slide-panel-footer relative shadow-outer-1 flex justify-center items-center z-2 pa4 ember-view">
                    ...
                    <button @click="addAppDomain" class="async-button w-50 default hk-button--primary ember-view" type="submit">Save changes</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
import SettingDomainAdd from "./SettingDomainAdd"
export default SettingDomainAdd
</script>
